...
| Enterprise AI adoption stalls at "cool demo" stage | Production-grade org template with 12 divisions, 9 quality policy domains, 4 process loops |
...
│  org/4-quality/    9 policy domains, eval agent fleets          │
└─────────────────────────────────────────────────────────────────┘
```
