...
| Gap | ISO 27001 Requirement | What's Needed | Severity | Remediation |
|-----|----------------------|---------------|----------|-------------|
| ~~Formal ISMS scope statement~~ | Clause 4.3 | Deployment must define ISMS boundaries, included/excluded assets | ~~High~~ → Addressed | [ISMS Scope Template](templates/_TEMPLATE-isms-scope.md) |
| ~~Statement of Applicability (SoA)~~ | Clause 6.1.3d | Formal document listing all 93 controls with justification for inclusion/exclusion | ~~High~~ → Addressed | [SoA Template](templates/_TEMPLATE-soa.md) |
| ~~Internal audit programme~~ | Clause 9.2 | Scheduled audit plan, auditor independence, audit reports | ~~High~~ → Addressed | [Internal Audit Template](templates/_TEMPLATE-isms-internal-audit.md) |
